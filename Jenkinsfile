pipeline {
   agent any
   parameters {
     string(name: 'SERVICE_NAME', defaultValue: 'fleetman-queue', description: 'Microservice name')
     string(name: 'ECR_REPO_NAME', defaultValue: 'fleetman-queue', description: 'ECR repo name')
